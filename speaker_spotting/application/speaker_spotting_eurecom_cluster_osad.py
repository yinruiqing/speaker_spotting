...
cluster_mdtm = '/people/yin/projects/online_clustering/spotting/EURECOM-online-diarization-oracle-VAD.dev.WithOffset.mdtm'
...
with open('./results/ss_eurecom_cluster_oracle_sad_representation.json', 'w') as outfile:  
